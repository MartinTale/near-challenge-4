...
const CONTRACT_NAME = "dev-1637404012796-51516199635312" || 'near-challenge-4.teller.testnet';
...
document.querySelector("form").onsubmit = async event => {
  ...
  try {
    ...
    }, BOATLOAD_OF_GAS, (0, _big.default)(document.getElementById("donation").value || '0').times(10 ** 24).toFixed());
  } catch (e) {
    console.log(e);
...
async function fetchGreeting() {
  ...
  renderAvatars(users); // document.querySelectorAll('[data-behavior=greeting]').forEach(el => {
  //   // set divs, spans, etc
...
},{"regenerator-runtime/runtime":"../node_modules/regenerator-runtime/runtime.js","./utils":"utils.js","./config":"config.js","big.js":"../node_modules/big.js/big.js"}],"../node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
var global = arguments[3];
